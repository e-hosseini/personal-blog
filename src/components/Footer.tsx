    ...
    <footer className="bg-white dark:bg-gray-900 border-t border-gray-100 dark:border-gray-800">
      <div className="max-w-7xl mx-auto px-4 py-24">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-16">
          <div>
            <h2 className="text-6xl font-light tracking-tight mb-16 text-gray-900 dark:text-gray-100">about</h2>
          </div>
          <div className="md:col-span-2">
            ...
            <div className="mt-12">
              <h3 className="text-xl font-light mb-4 text-gray-900 dark:text-gray-100">Ehsan Hosseini</h3>
              <p className="text-md font-light text-gray-700 dark:text-gray-300">me [at] ehosseini [dot] info</p>
            </div>
            <p className="text-md font-light leading-relaxed text-gray-700 dark:text-gray-300 mb-8">
