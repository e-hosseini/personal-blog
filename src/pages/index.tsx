  ...
  return (
    ...
    >
      <div className="max-w-3xl mx-auto px-4 py-8">
        <div className="mb-12">
          <div className="flex flex-col md:flex-row gap-8 items-center">
            ...
            <div className="flex-1">
              <h1 className="text-2xl font-playfair font-medium mb-2">Ehsan Hosseini</h1>
        ...
        <div>
          <h2 className="text-2xl font-playfair font-medium mb-6">Latest Articles</h2>
          <div className="space-y-6">
            {posts.map((post) => (
              <div key={post.id} className="border-b border-gray-100 pb-6">
                <Link to={post.fields.slug} className="block">
                  <h3 className="text-xl font-playfair font-medium text-gray-900 mb-2">{post.frontmatter.title}</h3>
